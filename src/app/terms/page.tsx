    ...
    <ProtectedRoute checkAuth={false}>
      <div className="app-container flex flex-col bg-gray-50">
        ...
        <main className="flex-1 overflow-y-auto p-6 text-gray-700 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-4">제5조 (회원의 의무)</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-4">제6조 (서비스의 변경 및 중단)</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-4">제7조 (회원의 게시물)</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-4">제8조 (면책 조항)</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-4">제9조 (분쟁 해결)</h2>
          <p className="mb-4">
