  ...
  return (
    <ProtectedRoute>
      <div className="app-container flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <main className="flex-1 flex flex-col items-center px-6 pt-4 pb-10 w-full max-w-md mx-auto relative">
          <ModernScrollbar className="w-full h-full min-h-0 flex-1">
                  ...
                  <div>
                    ...
                    <dl className="mt-4 space-y-2">
                      <div className="flex justify-between">
                        <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">보유 츄르</dt>
                        <dd className="text-sm text-gray-900 dark:text-gray-100">{wallet?.churuBalance ?? '-'} 츄르</dd>
                      </div>
                      <div className="flex justify-between">
                        <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">보유 캣닢</dt>
                  ...
                  <div>
                      ...
                      {amountPresets.map((amt) => (
                        <button
                          ...
                          className={`
                            ...
                            px-0 py-1.5 rounded-md border
                            text-md font-semibold transition text-center
                            ${chargeAmount === amt
                    ...
                    <div className="flex items-center space-x-2 mb-1">
                      <input
                        ...
                        className="w-2/3 py-1.5 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block border border-gray-300 dark:border-gray-600 rounded-md text-right bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
